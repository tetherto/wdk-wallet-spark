...
describe('WalletAccountSpark', () => {
  ...
  beforeAll(async () => {
    ...
    account = new WalletAccountSpark({ index, signer, wallet })
  })
  ...
  describe('constructor', () => {
    test('should successfully initialize an account for the given wallet instance', async () => {
      ...
      const account = new WalletAccountSpark({ index, signer, wallet: realWallet })

      expect(account.index).toBe(ACCOUNT.index)
      expect(account.path).toBe(ACCOUNT.path)
      expect(account.keyPair).toHaveProperty('privateKey')
      expect(account.keyPair).toHaveProperty('publicKey')
      expect(typeof account.keyPair.privateKey).toBe('object')
      expect(typeof account.keyPair.publicKey).toBe('object')
