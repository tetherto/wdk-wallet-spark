...
export type GetUnusedDepositAddressesOptions = import("./src/wallet-account-read-only-spark.js").GetUnusedDepositAddressesOptions;
export type GetUtxosForDepositAddressOptions = import("./src/wallet-account-read-only-spark.js").GetUtxosForDepositAddressOptions;
export type GetSparkInvoicesOptions = import("./src/wallet-account-read-only-spark.js").GetSparkInvoicesOptions;
